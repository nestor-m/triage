		...
		<div id="list-paciente" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="paciente.persona.label" default="Persona" /></th>
				...
				<g:each in="${pacienteInstanceList}" status="i" var="pacienteInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${pacienteInstance.id}">${fieldValue(bean: pacienteInstance, field: "persona")}</g:link></td>
